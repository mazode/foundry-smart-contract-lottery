...
contract RaffleTest is Test {
    ...
    function checkUpkeepReturnsFalseIfEnoughTimeHasntPassed() public {
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
    ...
    function checkUpkeepReturnsTrueWhenParametersGood() public {
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
        vm.warp(block.timestamp + interval + 1);
        vm.roll(block.number + 1);
    ...
    function testFulfillRandomWordsCanOnlyBeCalledAfterPerformUpkeep(
        ...
        vm.expectRevert("non existant request");
